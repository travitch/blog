...
-- | A pandoc filter to transform footnotes into sidenotes for use with Tufte-css
--
-- This module is taken from:
--
-- > https://raw.githubusercontent.com/jez/pandoc-sidenote/master/src/Text/Pandoc/SideNote.hs
